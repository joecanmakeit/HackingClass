...
public class MyHelmet extends ItemArmor {
	...
	//tier - an integer which is the 'tier' or level of the armor:
		...
		//4 - diamond
		//5+ - user-made armor
	public MyHelmet(ArmorMaterial material) {
		super(material, MyMod.armorMap.get(material.toString()), 0);
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
		return MyMod.modid+":textures/models/armor/" + this.material + "_layer_1.png";
	}
